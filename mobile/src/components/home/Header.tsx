...
export default function HomeHeader() {
  return (
    <View className="mt-10 flex flex-col gap-4 rounded-xl bg-[#5daee6] p-4">
      <View>
        <Text className="text-bold text-lg text-white">Bugünün özeti</Text>
      </View>
      ...
      <View className="flex flex-row justify-between">
        <Text className="text-bold text-lg text-white">%45 Tamamlandı</Text>
        <Text className="text-bold text-lg text-white">3/8 bitti</Text>
      </View>
      <View>
